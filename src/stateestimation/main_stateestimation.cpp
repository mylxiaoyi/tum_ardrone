...
*
*  Copyright 2012 Jakob Engel <jajuengel@gmail.com> (Technical University of
*Munich)
...
// kind of an artifact from Windows-Version, where only that was available /
// used.
...
int main(int argc, char **argv) {
  ...
  ROS_INFO("Started MyROS ArDrone Stateestimation Node.");

  EstimationNode estimator;

  dynamic_reconfigure::Server<myros_ardrone::StateestimationParamsConfig> srv;
  dynamic_reconfigure::Server<
      myros_ardrone::StateestimationParamsConfig>::CallbackType f;
